...
export function DeleteProduto() {
    ...
    function deletarProduto() {
        ...
        alert('Produtos deletada com sucesso.')
        history('/produtos')
    }
          ...
          <Grid container justifyContent={'center'} mt={4}>
            <Grid item xs={4}>
             ...
             <Typography variant='h3' gutterBottom align='center'>Deletar Postagem</Typography>
              <Typography variant='body1' gutterBottom align='center'>Você tem certeza de que deseja deletar a postagem com título: <br /> <strong>{produto?.nomeProduto}</strong> </Typography>
    
              <Box display='flex'>
                <Button variant='contained' color='primary' onClick={voltar} fullWidth>Não</Button>
                <Button variant='contained' color='error' onClick={deletarProduto} fullWidth >Sim</Button>
              </Box>
             </Card>
